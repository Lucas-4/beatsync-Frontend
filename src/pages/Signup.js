...
function Signup() {
  ...
  const [imageSrc, setImageSrc] = useState(
    process.env.REACT_APP_API_HOST + "/profile_images/default-profile-image.jpg"
  );
    ...
    <Main>
      ...
      >
        ...
        <TextInput
          ...
          error_message={
            userValidation === null ? null : userValidation.username.message
          }
        />
        <TextInput
          label="Display Name"
          ...
          error_message={
            userValidation === null ? null : userValidation.display_name.message
          }
        />
        <TextInput
          label="Bio"
          onChange={handleBio}
          error_message={
            userValidation === null ? null : userValidation.bio.message
          }
        />
